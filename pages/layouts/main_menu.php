...
<div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
      ...
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          ...
          <li class=" nav-item"><a href="#"><i class="icon-mobile2"></i><span class="menu-title">Externos</span></a>
            <ul class="menu-content">
              <li><a href="#" class="menu-item">Clientes</a></li>
              <li><a href="#" class="menu-item">Proveedores</a></li>
            </ul>
          </li>
          <li class=" nav-item"><a href="#"><i class="icon-dropbox"></i><span class="menu-title">Administración</span></a>
            <ul class="menu-content">
          ...
          <li class=" nav-item"><a href="#"><i class="icon-briefcase4"></i><span class="menu-title">Facturación</span></a>
            <ul class="menu-content">
