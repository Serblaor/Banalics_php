      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item"><a href="welcome.php" class="navbar-brand nav-link"><img alt="branding logo" src="../app-assets/images/ico/LogoBanalics.png" data-expand="../app-assets/images/ico/LogoBanalics.png" data-collapse="../app-assets/images/ico/LogoBanalics.png" class="brand-logo" style="height: 20px;width: 40px; "></a></li>
        ...
        <div class="navbar-container content container-fluid">
          <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
            ...
            <ul class="nav navbar-nav float-xs-right">
              <li class="dropdown dropdown-notification nav-item"><a href="#" data-toggle="dropdown" class="nav-link nav-link-label"><i class="ficon icon-bell4"></i><span class="tag tag-pill tag-default tag-danger tag-default tag-up"></span></a></li>
